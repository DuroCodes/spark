...
View the [`adding commands`](/docs/core-concepts/adding-commands) section for more information.
...
View the [`adding events`](/docs/core-concepts/adding-events) section for more information.
